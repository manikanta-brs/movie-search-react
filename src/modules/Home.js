...
export const Home = () => {
  ...
  let placeholder_text = "Seearch for a Movie ....";
  let [placeholder_txt, placeFunction] = useState("");
  useEffect(() => {
    let i = 0;
    const interval = setInterval(() => {
      if (i < placeholder_text.length - 1) {
        placeFunction((prev) => prev + placeholder_text[i]);
        i++;
      } else {
          ...
          <form onSubmit={handleButtonClick}>
            <div className="input-group mb-3">
              <input
                ...
                ref={searchRef}
                type="text"
                className="form-control shadow-none w-100 search-bar"
